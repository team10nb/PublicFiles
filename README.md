...
4. 完成了几个branch的整合, 将算法和页面结合了起来
5. 完成了三个基础算法的introduction部分trace的书写
6. 修复了image传入路径读取失败的问题
7. 修复了theme无法被读取导致button颜色不正确显示的问题
8. 正在进行help页面的精修
9. 正在进行correctness的下一步
10. 正在进行quick sort的优化
11. 正在进行merge sort
12. 正在进行JsxDoc的书写
13. 正在进行final report的计划
14. 正在进行各页面文案的搜集查找
15. 正在进行sorting algorithm的测试

遇到的问题:
1. 会议主持未事先准备
   - 延迟一小时开会, 如开会者不方便则由其他人代为准备
   - 在前一个礼拜要确定好下次会议的时间, 大家达成共识
2. issue没有及时清理
   - 通知大家及时完成任务后进行清理工作
   - 通知有bug及时issue
3. 整体进度比计划慢
...
1. 进行了部分上阶段完善工作，与heshan进行了软件洽谈，得到了些许意见
2. feedback总结了一下，等待完善期中报告

遇到的问题：

1. 会议中个人发言任务没有落实到个人，导致知晓任务迟了
2. dave商讨任务暂定

**2/23**
已完成任务总结：
1. 讨论了昨天formal meeting老师提出的问题，并分配了任务。
